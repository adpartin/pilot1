"""
Using PyTorch train NN model for prediction anti-cancer drug response from raw datasets.
Train model using raw data where cell features, drug features, and  response data are initially
stored in separate dataset. The datasets were provided by Yitan.
"""
